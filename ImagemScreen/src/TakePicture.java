...
public class TakePicture extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelFiltroLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelFiltroLayout.createSequentialGroup()
                ...
                .addGroup(jPanelFiltroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jSliderFiltro, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
        ...
        jSliderFiltro.getAccessibleContext().setAccessibleDescription("Escolher o filtro a ser aplicado na imagem");
        ...
        jSliderFiltroOpc.getAccessibleContext().setAccessibleDescription("Alterar os ajustes do filtro selecionado");
        ...
        jPanelBotoeiraLayout.setVerticalGroup(
            jPanelBotoeiraLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelBotoeiraLayout.createSequentialGroup()
                        ...
                        try {
                            ...
                            switch (filtroOpc) {
                                ...
                                case 10:
                                    ...
                                    lblNumFiltro.setText(msg + jSliderFiltro.getValue());
                                    lblNumFiltroOpc.setText(jSliderFiltroOpc.getValue() + " " + msgOpcFiltro);
                                    FLAG_FILTRO = 10; //FILTRO JAVA PURO
                                    System.out.println("Esta é a:" + filtroOpc);
                                    break;
                                ...
                                case 23:
                                    msg = "Filtro psicodelico ";
                                    msgOpcFiltro = msg;
                                    lblNumFiltro.setText(msg + jSliderFiltro.getValue());
                                    lblNumFiltroOpc.setText(jSliderFiltroOpc.getValue() + " " + msgOpcFiltro);
                                    FLAG_FILTRO = 23; //FILTRO JAVA PURO
                                    System.out.println("Esta é a:" + filtroOpc);
                                    break;
