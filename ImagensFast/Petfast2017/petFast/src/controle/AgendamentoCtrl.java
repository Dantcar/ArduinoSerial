 ...
 *  07 - listarAgendamentoClienteCtrl()
...
public class AgendamentoCtrl {
    ...
    /**
     * 01 - receberIdAgendamentoAtual() Método controle receber o id do último
     * agendamento cadastrado. se não existir o id atual será 0
     *
    ...
    /**
     * 2 - inserirAgendamentoCtrl() Método controle enviar agendamento para
     * cadastro
     *
     * @param agendamento
     */
    ...
    /**
     * 3 - alterarAgendamentoCtrl() Método controle para enviar agendamento para
     * alteração enviando o agendamento alterado e seu id
     *
     * @param agendamento
     * @param vid
     */
    ...
    /**
     * 4 - excluirAgendamentoCtrl() Método controle para enviar agendamento para
     * exclusão enviando o seu id
     *
     * @param vid
     */
    ...
    /**
     * 5 - contarAgendamentoHorarioCtrl() Método que executa a contagem dos
     * registros que atendem ao dia e hora enviados.
     *
     * @param vData
     * @param vHora
    ...
    /**
     * 6 - listarAgendamentoHorarioCtrl(); Método que recebe uma lista de
     * agendamento de determinado dia e horário, enviando estes dados dia e
     * horário.
     *
     * @param vData
     * @param vHora
    ...
    /**
     * 7 - listarAgendamentoClienteCtrl() Método que recebe uma lista de
     * agendamento de determinado Cliente enviando como parâmetro o seu
     * respectivo id.
     *
     * @param vid
     * @return
    ...
    /**
     * 8 - listarAgendamentoCtrl() Método que recebe uma lista de agendamento de
     * determinado Cliente enviando como parâmetro o seu respectivo id.
     *
     * @param vid
     * @return
     */
